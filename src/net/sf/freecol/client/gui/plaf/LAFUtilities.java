...
public final class LAFUtilities {
	 ...
	 * {@link JComponent#getClientProperty(Object) client property} from the
	 * given component.
	 *
	 * Currently only <code>RenderingHints.KEY_TEXT_ANTIALIASING</code> is
	 * supported. Antialiasing is enabled explicitly if the text size is larger
	 * or equal to 16.
	 *
	 * @param g
	 *            The graphics object to be updated.
	 * @param c
