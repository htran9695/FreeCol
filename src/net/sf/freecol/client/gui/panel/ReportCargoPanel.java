...
public final class ReportCargoPanel extends ReportUnitPanel {
	...
	protected void addOwnUnits() {
		...
		for (UnitType unitType : getSpecification().getUnitTypeList()) {
			if (unitType.isAvailableTo(player) && (unitType.canCarryUnits() || unitType.canCarryGoods())) {
				AbstractUnit unit = new AbstractUnit(unitType, Specification.DEFAULT_ROLE_ID,
