...
public final class ClientOptionsDialog extends OptionsDialog {
	...
	public ClientOptionsDialog(FreeColClient freeColClient, JFrame frame) {
		super(freeColClient, frame, true, freeColClient.getClientOptions(), freeColClient.getClientOptions().getId(),
				FreeColDirectories.CLIENT_OPTIONS_FILE_NAME, ClientOptions.getXMLElementTagName());
