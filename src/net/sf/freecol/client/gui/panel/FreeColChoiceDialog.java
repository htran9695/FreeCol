...
public class FreeColChoiceDialog<T> extends FreeColDialog<T> {
	...
	/**
	 * Create a new <code>FreeColChoiceDialog</code> with a text and a ok/cancel
	 * option.
	 *
	 * @param freeColClient
	 *            The <code>FreeColClient</code> for the game.
	 ...
	 * @param choices
	 *            A list of <code>ChoiceItem</code>s to create buttons for.
	 */
	public FreeColChoiceDialog(final FreeColClient freeColClient, JFrame frame, boolean modal, Object obj,
			ImageIcon icon, String cancelKey, List<ChoiceItem<T>> choices) {
	 ...
	 *            A list of <code>ChoiceItem</code>s to create buttons for.
	 */
	protected final void initializeChoiceDialog(JFrame frame, boolean modal, Object obj, ImageIcon icon,
			String cancelKey, List<ChoiceItem<T>> choices) {
		if (cancelKey != null) {
			choices.add(new ChoiceItem<>(Messages.message(cancelKey), (T) null).cancelOption().defaultOption());
		}
