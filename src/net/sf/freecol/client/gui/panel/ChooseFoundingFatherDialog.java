...
public final class ChooseFoundingFatherDialog extends FreeColDialog<FoundingFather> {
	 ...
	 * @param frame
	 *            The owner frame.
	 * @param possibleFoundingFathers
	 *            The Founding Fathers which can be selected. The length of the
	 *            array is the same as the number of <code>FoundingFather</code>
	 *            categories and the values identifies a
	 *            <code>FoundingFather</code> to be picked in each of those
	 *            categories.
	 */
	public ChooseFoundingFatherDialog(FreeColClient freeColClient, JFrame frame,
		...
		c.add(new ChoiceItem<>(Messages.message("ok"), (FoundingFather) null).okOption().defaultOption());
