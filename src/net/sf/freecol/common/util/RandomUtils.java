...
/**
 * Collection of small static helper routines for logged pseudo-random number
 * generation.
 */
public class RandomUtils {
	 ...
	 * @param logMe
	 *            A string to log with the result.
	 * @param random
	 *            A pseudo-<code>Random</code> number source.
	 * @param range
	 *            The exclusive maximum integer to return.
