...
/**
 * Keeps track of the available map generator options. More of a handy place to
 * organize the names than an actual option type.
 *
 * @see MapGenerator
...
public class MapGeneratorOptions {
	...
	public static final String MAPGENERATOROPTIONS_LAND_GENERATOR = "mapGeneratorOptions.landGenerator";

	/** Option for setting the map width. */
	public static final String MAP_WIDTH = "model.option.mapWidth";

	/** Option for setting the map height. */
	public static final String MAP_HEIGHT = "model.option.mapHeight";
	...
	public static final String LAND_GENERATOR_TYPE = "model.option.landGeneratorType";

	/** The Constant LAND_GENERATOR_ISLANDS. */
	public static final int LAND_GENERATOR_CLASSIC = 0, LAND_GENERATOR_CONTINENT = 1, LAND_GENERATOR_ARCHIPELAGO = 2,
			LAND_GENERATOR_ISLANDS = 3;

	/** Option for setting the preferred distance to the map edge. */
	public static final String PREFERRED_DISTANCE_TO_EDGE = "model.option.preferredDistanceToEdge";

	/** Option for setting the maximum distance to the map edge. */
	public static final String MAXIMUM_DISTANCE_TO_EDGE = "model.option.maximumDistanceToEdge";

	/** Option for setting the distance to the high seas. */
	public static final String DISTANCE_TO_HIGH_SEA = "model.option.distanceToHighSea";

	/** Map generator options terrain generator group. */
	public static final String MAPGENERATOROPTIONS_TERRAIN_GENERATOR = "mapGeneratorOptions.terrainGenerator";
