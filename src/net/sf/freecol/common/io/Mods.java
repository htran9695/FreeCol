...
public class Mods {
	...
	/**
	 * Require all mods to be loaded. This must be delayed until the mods
	 ...
	 *
	 * @param id
	 *            The identifier of the mod to search for.
	 * @return The <code>FreeColModFile</code> for the mod, or null if not
	 *         found.
	 */
	...
	/**
	 * Gets all available mods. User mods before standard mods to allow user
	 * override.
	 *
	 ...
	 *
	 * @param id
	 *            The mod file identifier to look for.
