...
public class SetCurrentStopMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>SetCurrentStopMessage</code> for the supplied unit.
	 *
	 * @param unit
	 *            A <code>Unit</code> whose stop is to be setd.
	 * @param index
	 *            the index
	 */
	...
	/**
	 * Create a new <code>SetCurrentStopMessage</code> from a supplied element.
	 *
	 * @param game
	 ...
	 * @return An set containing the unit after updating its current stop, or an
	...
	public Element handle(FreeColServer server, Connection connection) {
		...
		if (tr == null) {
			return DOMMessage.clientError("Unit has no trade route: " + unitId);
		}
	...
	public Element toXMLElement() {
		return createMessage(getXMLElementTagName(), "unit", unitId, "index", index);
	}
