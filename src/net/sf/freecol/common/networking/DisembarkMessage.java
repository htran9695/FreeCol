...
public class DisembarkMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>DisembarkMessage</code> with the supplied name.
	 *
	 * @param unit
	...
	/**
	 * Create a new <code>DisembarkMessage</code> from a supplied element.
	 *
	 * @param game
	...
	public Element toXMLElement() {
		return createMessage(getXMLElementTagName(), "unit", unitId);
	}
