...
public class ScoutIndianSettlementMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>ScoutIndianSettlementMessage</code> with the supplied
	 * unit and direction.
	 *
	 * @param unit
	...
	/**
	 * Create a new <code>ScoutIndianSettlementMessage</code> from a supplied
	 * element.
	 *
	 * @param game
	 ...
	 * @return An element containing the result of the scouting action, or an
	...
	public Element handle(FreeColServer server, Player player, Connection connection) {
		...
		return server.getInGameController().scoutIndianSettlement(serverPlayer, unit, is);
	}
