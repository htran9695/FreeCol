...
public class AssignTradeRouteMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>AssignTradeRouteMessage</code> with the supplied unit
	 * and route.
	 *
	 * @param unit
	...
	/**
	 * Create a new <code>AssignTradeRouteMessage</code> from a supplied
	 * element.
	 *
	 * @param game
	 ...
	 * @return An update containing the assignTradeRouted unit, or an error
	...
	public Element toXMLElement() {
		Element result = createMessage(getXMLElementTagName(), "unit", unitId);
		if (tradeRouteId != null) {
