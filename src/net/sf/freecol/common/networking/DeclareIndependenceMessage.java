...
public class DeclareIndependenceMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>DeclareIndependenceMessage</code> with the supplied
	 * name.
	 *
	 * @param nationName
	 *            The new name for the rebelling nation.
	...
	/**
	 * Create a new <code>DeclareIndependenceMessage</code> from a supplied
	 * element.
	 *
	 * @param game
	 ...
	 *         player, or an error <code>Element</code> on failure.
	 */
	public Element handle(FreeColServer server, Player player, Connection connection) {
		final ServerPlayer serverPlayer = server.getPlayer(connection);

		if (nationName == null || nationName.isEmpty() || countryName == null || countryName.isEmpty()) {
		...
		// Declare.
		return server.getInGameController().declareIndependence(serverPlayer, nationName, countryName);
	}
	...
	public Element toXMLElement() {
		return createMessage(getXMLElementTagName(), "nationName", nationName, "countryName", countryName);
	}
