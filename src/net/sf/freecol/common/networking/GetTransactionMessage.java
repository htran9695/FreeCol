...
public class GetTransactionMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>GetTransactionMessage</code> with the supplied unit
	 * and settlement.
	 *
	 * @param unit
	 *            The <code>Unit</code> performing the transaction.
	 * @param settlement
	 *            The <code>Settlement</code> where the transaction occurs.
	 */
	...
	/**
	 * Create a new <code>GetTransactionMessage</code> from a supplied element.
	 *
	 * @param game
	 ...
	 * @return A reply encapsulating the possibilities for this transaction, or
	...
	public Element toXMLElement() {
		return createMessage(getXMLElementTagName(), "unit", unitId, "settlement", settlementId);
	}
