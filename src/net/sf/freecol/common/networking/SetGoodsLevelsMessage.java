...
public class SetGoodsLevelsMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>SetGoodsLevelsMessage</code> with the supplied colony
	 * and data.
	 *
	 * @param colony
	 *            The <code>Colony</code> where the goods leves are set.
	 * @param data
	...
	/**
	 * Create a new <code>SetGoodsLevelsMessage</code> from a supplied element.
	 *
	 * @param game
	...
	public Element handle(FreeColServer server, Player player, Connection connection) {
		...
		// Proceed to set.
		return server.getInGameController().setGoodsLevels(serverPlayer, colony, data);
	}
	...
	public Element toXMLElement() {
		Element result = createMessage(getXMLElementTagName(), "colony", colonyId);
