...
public class RenameMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>RenameMessage</code> with the supplied name.
	 *
	 * @param object
	 *            The <code>FreeColGameObject</code> to rename.
	 * @param newName
	...
	/**
	 * Create a new <code>RenameMessage</code> from a supplied element.
	 *
	 * @param game
	 ...
	 *
	 * @return An update containing the renamed unit, or an error
	...
	public Element handle(FreeColServer server, Player player, Connection connection) {
		...
		// Proceed to rename.
		return server.getInGameController().renameObject(serverPlayer, (Nameable) fcgo, newName);
	}
	...
	public Element toXMLElement() {
		return createMessage(getXMLElementTagName(), "nameable", id, "name", newName);
	}
