...
public class MoveToMessage extends DOMMessage {
	...
	/**
	 * Create a new <code>MoveToMessage</code> for the supplied unit and
	 * destination.
	 *
	 * @param unit
	...
	/**
	 * Create a new <code>MoveToMessage</code> from a supplied element.
	 *
	 * @param game
	...
	public Element toXMLElement() {
		return DOMMessage.createMessage(getXMLElementTagName(), "unit", unitId, "destination", destinationId);
	}
