...
public abstract class TradeItem extends FreeColObject {
	 ...
	 *
	 * @param newSource
	 *            The new source <code>Player</code>.
	 */
	 ...
	 *            The new destination <code>Player</code>.
	 */
	 ...
	 *
	 * @param player
	 *            The <code>Player</code> we do not want.
	 ...
	 *
	 * @param game
	 *            A <code>Game</code> to look for the colony in.
	 ...
	 *
	 * @param goods
	 *            The new <code>Goods</code> to trade.
	 */
	 ...
	 *
	 * @param stance
	 *            The new <code>Stance</code> to trade.
	 */
	 ...
	 *
	 * @param unit
	 *            The new <code>Unit</code> to trade.
	 */
	...
	protected void readAttributes(FreeColXMLReader xr) throws XMLStreamException {
		...
		source = xr.getAttribute(game, SOURCE_TAG, Player.class, (Player) null);

		destination = xr.getAttribute(game, DESTINATION_TAG, Player.class, (Player) null);
	}
}
