...
public class ColonyTradeItem extends TradeItem {
	...
	public StringTemplate getLabel() {
		return StringTemplate.template(Messages.descriptionKey("model.tradeItem.colony")).addName("%colony%",
				colonyName);
	}
	...
	public boolean equals(Object other) {
		if (other instanceof ColonyTradeItem) {
			return Utils.equals(this.colonyId, ((ColonyTradeItem) other).colonyId)
					&& Utils.equals(this.colonyName, ((ColonyTradeItem) other).colonyName) && super.equals(other);
		}
		return false;
	}
