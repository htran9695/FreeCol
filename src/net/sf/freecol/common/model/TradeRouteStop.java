...
public class TradeRouteStop extends FreeColObject implements TradeLocation {
	 ...
	 *            the game
	 * @param location
	 *            The <code>Location</code> of this stop.
	 */
	 ...
	 *
	 * @param other
	 *            The other <code>TradeRouteStop</code>.
	 */
	 ...
	 *
	 * @param newCargo
	 *            A list of <code>GoodsType</code> defining the cargo.
	 */
	...
	/**
	 * Get a list of the maximum abstract goods that could be loaded at this
	 * stop. That is, a list of all the cargo goods types normally with amount
	 * equal to one CARGO_SIZE, but with duplicates removed and amounts
	 * accumulated.
	 *
	 ...
	 *            A message key.
	 * @param player
	 *            The <code>Player</code> who will see the message.
	 ...
	 * @param turns
	 *            Account for production from this many turns.
	...
	public String toString() {
		...
		sb.append("[").append(getXMLTagName()).append(" ").append(getLocation().getId());
