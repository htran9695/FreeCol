...
/**
 * The <code>Ability</code> class encapsulates a bonus or penalty that can be
...
public final class Ability extends Feature {
	...
	/**
	 * The ability of certain buildings (e.g. the stables) to produce goods even
	 * if no units are present.
	 */
	public static final String AUTO_PRODUCTION = "model.ability.autoProduction";

	/**
	 * The ability of certain buildings (e.g. the stables) to avoid producing
	 * more goods than the colony can store, which would normally go to waste.
	 */
	...
	/**
	 * The ability to be born in a Colony. Only Units with this ability can be
	 * produced by a Colony.
	 */
	public static final String BORN_IN_COLONY = "model.ability.bornInColony";

	/**
	 * The ability to be born in an IndianSettlement. Only Units with this
	 * ability can be produced by an IndianSettlement.
	 */
	public static final String BORN_IN_INDIAN_SETTLEMENT = "model.ability.bornInIndianSettlement";

	/**
	 * The ability to build {@link BuildableType}s, such as units. The shipyard
	 * provides the ability to build ships, for example.
	 */
	 ...
	 * units. Units lacking this ability (e.g. braves) will be destroyed
	 * instead.
	 */
	...
	/**
	 * The ability of certain units (e.g. privateers) to capture goods carried
	 * by another player's units.
	 */
	...
	/**
	 * The ability of certain consumers (e.g. BuildQueues) to consume a large
	 * amount of goods at once instead of turn by turn.
	 */
	...
	/**
	 * The somewhat controversial ability of expert units in factory level
	 * buildings to produce a certain amount of goods even when no raw materials
	 * are available. Allegedly, this is a feature of the original game.
	 */
	...
	/**
	 * The ability denoting that this is an independent nation. Note: this
	 * differs from INDEPENDENCE_DECLARED in that the REF is also (representing)
	...
	/**
	 * The ability of certain units (e.g. privateers) to attack and plunder
	 ...
	 *            The object identifier.
	 * @param source
	 *            The source <code>FreeColGameObjectType</code>.
	 * @param value
	 *            The ability value.
	 */
	 ...
	 *
	 * @param template
	 *            An <code>Ability</code> to copy from.
	 */
	 ...
	 * @param specification
	 *            A <code>Specification</code> to refer to.
