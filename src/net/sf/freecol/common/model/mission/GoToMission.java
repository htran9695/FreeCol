...
public class GoToMission extends AbstractMission {
	 ...
	 *
	 * @param newBlockedCount
	 *            The new BlockedCount value.
	 */
	...
	public boolean isValid() {
		return super.isValid() && destination != null
		// FIXME: check for disposed destinations
				&& destination.canAdd(getUnit());
	}

	/**
	 * Returns true if the given Unit has movement points. At the moment, this
