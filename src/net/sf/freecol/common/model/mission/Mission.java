...
/**
 * The Mission interface describes some kind of order that can be given to a
 * {@link Unit}, such as the order to move to a certain Tile, attack a certain
 * Unit, or build a TileImprovement, for example. Missions can be atomic, or
...
public interface Mission {
	...
	public static enum MissionState {
		...
		BLOCKED,
		/**
		 * Mission has been aborted, e.g. because a target or destination has
		 * been destroyed.
		 */
		ABORTED
	};
	...
	/**
	 * Returns true if the mission is still valid. This might not be the case if
	 * its target or destination have been destroyed, or if the Unit this
	 * mission was assigned to was destroyed or changed owner, for example.
	 *
