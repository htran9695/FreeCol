...
public abstract class AbstractMission extends FreeColGameObject implements Mission {
	...
	/**
	 * The number of turns this mission will take to carry out. In most cases,
	 * this will be zero, since most missions do not take a fixed number of
	 * turns to carry out. Building TileImprovements and learning in school
	 * would be exceptions, however.
	 */
	 ...
	 *
	 * @param newRepeatCount
	 *            The new RepeatCount value.
	 */
	...
	/**
	 * Returns true if the Unit this mission was assigned to is neither null nor
	 * has been disposed, and the repeat count of the mission is greater than
	 * zero.
	 *
	...
	/**
	 * Returns true if this is a valid Mission for the given Unit. This method
	 * always returns false and needs to be overridden.
	 *
	 * @param unit
