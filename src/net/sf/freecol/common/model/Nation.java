...
public class Nation extends FreeColGameObjectType {
	...
	/**
	 * A list of European nation names, where model.nation.X.name exists. Used
	 * by getNonPlayerNation().
	 */
	...
	public final Nation getRebelNation() {
		return find(getSpecification().getEuropeanNations(), n -> n.getREFNation() == this);
	}
	...
	/**
	 * Enforce the default color for this nation. Call this if getColor() is
	 * returning null, which should only happen if a colorless old specification
	 * is in force.
	 *
