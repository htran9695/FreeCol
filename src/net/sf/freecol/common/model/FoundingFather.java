...
/**
 * Represents one FoundingFather to be contained in a Player object. The
 * FoundingFather is able to grant new abilities or bonuses to the player, or to
...
public class FoundingFather extends FreeColGameObjectType {
	 ...
	 *
	 * @param type
	 *            A new <code>FoundingFatherType</code>.
	 */
	 ...
	 *
	 * @param type
	 *            The <code>FoundingFatherType</code> to make a key for.
	...
	/**
	 * Get the weight of this FoundingFather. This is used to select a random
	 * FoundingFather.
	 *
	 * @param age
	 *            The age ([0, 2])
	...
	public final Map<UnitType, UnitType> getUpgrades() {
		return (upgrades == null) ? Collections.<UnitType, UnitType>emptyMap() : upgrades;
	}
	 ...
	 *
	 * @param fromType
	 *            The initial <code>UnitType</code>.
	 * @param toType
	...
	public final List<AbstractUnit> getUnits() {
		return (units == null) ? Collections.<AbstractUnit>emptyList() : units;
	}
	...
	protected void readChild(FreeColXMLReader xr) throws XMLStreamException {
		...
		if (UPGRADE_TAG.equals(tag)) {
			UnitType fromType = xr.getType(spec, FROM_ID_TAG, UnitType.class, (UnitType) null);
