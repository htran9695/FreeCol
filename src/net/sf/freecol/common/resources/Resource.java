 ...
 * <code>URI</code>. There can only be one instance of <code>Resource</code>
 * having the same (as in URI's equals, not the identity) <code>URI</code>.
 */
public abstract class Resource {

	/**
	 * Implement the Preloadable interface if a Resource has a use for calls to
	 * a preload method.
	 */
	...
	/**
	 * Implement the Cleanable interface if a Resource has a use for calls to a
	 * clean method.
	 */
